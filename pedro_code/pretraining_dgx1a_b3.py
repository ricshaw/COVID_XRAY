...
if TRAIN:
    for epoch in range(loaded_epoch+1, EPOCHS):
        ...
        for i, sample in enumerate(train_loader):
            ...
            pos_weighting = labels[labels == 0.0].numel() / (labels[labels == 1.0].numel() + 0.1)
        ...
        if epoch % 1 == 0:
            for images, names, labels in val_loader:
                ...
                x_shape = 16
                x_stride = 8
                attributions = oc.attribute(image, sliding_window_shapes=(3, x_shape, x_shape),
                ...
                writer.add_image('Interpretability/Occlusions', image_normaliser(attributions_grid), running_iter)
                break
        ...
        writer.add_scalars(f'Loss/AUCs', {
            'Atelectasis': class_auc[0],
            'Cardiomegaly': class_auc[1],
            'Consolidation': class_auc[2],
            'Edema': class_auc[3],
            'Effusion': class_auc[4],
            'Emphysema': class_auc[5],
            'Fibrosis': class_auc[6],
            'Hernia': class_auc[7],
            'Infiltration': class_auc[8],
            'Mass': class_auc[9],
            'Nodule': class_auc[10],
            'Pleural_Thickening': class_auc[11],
            'Pneumonia': class_auc[12],
            'Pneumothorax': class_auc[13],
        }, running_iter)
        writer.add_scalars(f'Loss/PR_AUCs', {
            'Atelectasis': class_pr[0],
            'Cardiomegaly': class_pr[1],
            'Consolidation': class_pr[2],
            'Edema': class_pr[3],
            'Effusion': class_pr[4],
            'Emphysema': class_pr[5],
            'Fibrosis': class_pr[6],
            'Hernia': class_pr[7],
            'Infiltration': class_pr[8],
            'Mass': class_pr[9],
            'Nodule': class_pr[10],
            'Pleural_Thickening': class_pr[11],
            'Pneumonia': class_pr[12],
            'Pneumothorax': class_pr[13],
        }, running_iter)
